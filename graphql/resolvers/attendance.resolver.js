      ...
      try {
        ...
        course.enrolledStudents.map(async (studentID) => {
          const sendNotification = new Notification({
            ...
            Enter room using URL: https://smartmark.netlify.app/course/${course.shortID}/attendanceRoom/${attendance._id}`,
          });
          await sendNotification.save();
          Object.assign(course, {
            attendanceID: attendance,
            attendanceURL: `https://smartmark.netlify.app/course/${course.shortID}/attendanceRoom/${attendance._id}`,
          });
